...
public class MainMenuScreen extends GLScreen {
	...
	public MainMenuScreen(Game game) {
		...
		soundBounds = new Rectangle(0, 0, 60, 50);
		playBounds = new Rectangle(80, 120, 160, 60);
		collectionBounds = new Rectangle(160, 180, 160, 80);
		helpBounds = new Rectangle(0, 180, 160, 80);
	...
	public void update(float deltaTime) {
		...
		for(int i = 0; i < len; i++) {
			...
			if(event.type == TouchEvent.TOUCH_UP) {
				...
				if(OverlapTester.pointInRectangle(collectionBounds, touchPoint)) {
					Assets.playSound(Assets.clickSound);
	...
	public void present(float deltaTime) {
		...
		batcher.drawSprite(160, 240, 320, 480, Assets.menuRegion);
		batcher.endBatch();
		...
		batcher.drawSprite(30, 25, 60, 50, 
